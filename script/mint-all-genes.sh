...
# Mint Cute Orangey Aminal Genes using cast
# This is an example script showing how to mint 8 genes for one Aminal
# Usage: PRIVATE_KEY=0x... RPC_URL=https://... ./script/mint-cute-orangey-genes.sh
...
if [ -z "$PRIVATE_KEY" ]; then
    ...
    echo "Usage: PRIVATE_KEY=0x... RPC_URL=https://... ./script/mint-cute-orangey-genes.sh"
    exit 1
fi
...
mint_gene() {
    ...
    echo -e "${YELLOW}→ Minting: $description (category $category)${NC}"
