...
/**
 * @title ThreeEyedGenesMinter
 * @dev Contract to mint initial genes for Three-Eyed Aminal (8 genes)
 * This contract is deployed temporarily just to mint these specific genes, then discarded
 */
contract ThreeEyedGenesMinter {
    /**
    ...
    function mintGenes(GeneRegistry registry) external {
        ...
        registry.createGeneFor(msg.sender, '<g id="MOUTH"></g>', IAminalStructs.VisualsCat.MOUTH);
