 ...
 * @dev Single contract with 4 functions to mint initial genes for the Aminals ecosystem
 * Each function mints genes for one Aminal (8 genes each) to allow separate transactions
...
contract InitialGenesMinter {
     ...
     */
    function mintCuteOrangeyGenes(GeneRegistry registry) external {
    ...
    /**
     * @notice Mint genes for Three-Eyed Aminal (8 genes)
     * @param registry The GeneRegistry contract to create genes through
     */
    function mintThreeEyedGenes(GeneRegistry registry) external {
        // ORDER MUST BE RESPECTED AT ALL COSTS:
        // Order: backId, armId, tailId, earsId, bodyId, faceId, mouthId, miscId
        ...
        registry.createGene('<g id="MOUTH"></g>', IAminalStructs.VisualsCat.MOUTH);
     ...
     * @param registry The GeneRegistry contract to create genes through
     */
    function mintBlueAnimatedGenes(GeneRegistry registry) external {
        // ORDER MUST BE RESPECTED AT ALL COSTS:
        // Order: backId, armId, tailId, earsId, bodyId, faceId, mouthId, miscId
     ...
     * @param registry The GeneRegistry contract to create genes through
     */
    function mintRedAnimatedGenes(GeneRegistry registry) external {
        // ORDER MUST BE RESPECTED AT ALL COSTS:
        // Order: backId, armId, tailId, earsId, bodyId, faceId, mouthId, miscId
