...
contract AminalScript is Script {
    ...
    function deployAminalFactory() public returns (address) {
        ...
        GeneAuction _geneAuction = new GeneAuction(
            address(vm.envAddress("GENERATOR_SOURCE_CONTRACT")), address(vm.envAddress("GENERATOR_SOURCE_BALANCE"))
        );
    ...
    function spawnInitialAminals(AminalFactory factory) public {
    ...
    function run() external {
        ...
        // Add initial traits - first aminal
        factory.addBackground('<g id="BACK"><rect fill="#4e2f91" x="0" y="0" width="1000px" height="1000px"/></g>');
        factory.addTail(
        ...
        factory.addMouth('<circle cx="500" cy="354" r="10" fill="#385e5d"/>');
        factory.addMisc(
        ...
        // Second aminal
        factory.addBackground('<g><rect fill="#00a79d" x="0" y="0" width="1000px" height="1000px"/></g>');
        factory.addTail(
