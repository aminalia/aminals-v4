...
contract GeneNFTSystemTest is Test, IAminalStructs {
    ...
    function _createAuctionThroughBreeding() internal returns (uint256 auctionId) {
        ...
        return aminalFactory.breedAminals(aminalOne, aminalTwo);
    }
    ...
    function testAuctionCreation() public {
        ...
        vm.prank(alice);
        uint256 auctionId = aminalFactory.breedAminals(aminalOne, aminalTwo);
    ...
    function testAminalFactoryIntegration() public {
        ...
        address childAminal = aminalFactory.spawnAminal(parent1, parent2, 1, winningGenes);
